...
const Home = () => {
   ...
   return(
      <main>
         ...
         <div
            className={`profileWrapper ${visibleWrappers.includes(1) ? "profileWrapper--visible" : ""}`}
            ref={(el) => (wrappersRef.current[1] = el)}
         >
         ...
         <div
            className={`profileWrapper ${visibleWrappers.includes(2) ? "profileWrapper--visible" : ""}`}
            ref={(el) => (wrappersRef.current[2] = el)}
         >
         ...
         <div
            className={`profileWrapper ${visibleWrappers.includes(4) ? "profileWrapper--visible" : ""}`}
            ref={(el) => (wrappersRef.current[4] = el)}
         >
